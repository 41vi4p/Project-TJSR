...
export default function ScraperRedirect() {
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] gap-6 text-center max-w-md mx-auto">
      ...
      <div>
        <h1 className="text-2xl font-bold theme-text mb-2">Scraper Control</h1>
        <p className="theme-muted">
          Scraper controls are available in the <strong>Admin Panel</strong> running locally on your machine (port 3001).
