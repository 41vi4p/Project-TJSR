  ...
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] gap-6 text-center max-w-md mx-auto">
      <div className="p-4 bg-yellow-400/10 rounded-2xl border theme-border">
        <Bug size={40} className="text-yellow-500" />
      </div>
      <div>
        <h1 className="text-2xl font-bold theme-text mb-2">Debug Logs</h1>
        <p className="theme-muted">
          Debug logs are available in the <strong>Admin Panel</strong> running locally on your machine (port 3001).
